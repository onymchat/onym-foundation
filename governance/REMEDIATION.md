...
listed as specified, neither can carry a conformance claim, and step 8 of the
sequence below still puts protocol-kernel and exit work ahead of new seats in
the spending order. The boundary is published first because both seats create
